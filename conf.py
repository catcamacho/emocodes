...
sys.path.insert(0, os.path.abspath('../../emocodes/analysis'))
sys.path.insert(0, os.path.abspath('../../emocodes/plotting'))
sys.path.insert(0, os.path.abspath('../../emocodes/processing'))
